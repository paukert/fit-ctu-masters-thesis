...
\ctufitkeywordsCZE{měření výkonnosti vývojářů, metriky, gamifikace, single-page webová aplikace, GitHub, GitLab, PHP, Vue.js}
\ctufitkeywordsENG{measuring developer performance, metrics, gamification, single-page web application, GitHub, GitLab, PHP, Vue.js}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% END FILL IN
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\include{other/appendix} % include `appendix.tex' from `other/' subdirectory

\backmatter % do not remove this command

\printbibliography % print out the BibLaTeX-generated bibliography list

\include{other/medium} % include `medium.tex' from `other/' subdirectory
