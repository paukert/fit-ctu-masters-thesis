...
\ctufitkeywordsCZE{měření výkonnosti vývojářů, metriky, single-page webová aplikace, GitHub, GitLab, PHP, Vue.js}
\ctufitkeywordsENG{measuring developer performance, metrics, single-page web application, GitHub, GitLab, PHP, Vue.js}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% END FILL IN
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
