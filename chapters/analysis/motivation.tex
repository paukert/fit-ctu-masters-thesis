...
Jedním z klíčových prvků pro celkový úspěch projektu je motivace vývojářů. Studie potvrzují, že motivovaní programátoři odvádějí lepší práci, což se pozitivně projevuje jak například na produktivitě vývojového týmu, tak i kvalitě dodávaného produktu nebo na dodržování rozpočtů. Z tohoto důvodu se firmy snaží hledat různé možnosti, jak motivovat své zaměstance. \cite{developer-motivation, motivation-agile-teams}
