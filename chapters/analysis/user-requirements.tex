...
\begin{enumerate}[label=\textcolor{decoration}{\textbf{N\arabic*}}, leftmargin=9mm]
    ...
    \myItem{technologie}
    Webová aplikace bude připravená na provozování pomocí technologie Docker tj. bude dodána s připraveným souborem \mintinline{text}|Dockerfile|, který umožní sestavení spustitelného obrazu.
