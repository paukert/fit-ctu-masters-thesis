...
\begin{enumerate}[label=\textcolor{decoration}{\textbf{F\arabic*}}, leftmargin=9mm]
    ...
    Data získaná ze systémů GitHub a GitLab budou ve webové aplikaci přehledně prezentována ve formě grafů nebo tabulek. Tyto přehledy budou dostupné jak pro jednotlivé uživatele, tak i pro skupiny uživatelů. Přehledy bude možné filtrovat dle období, projektu a platformy.
\end{enumerate}
...
\begin{itemize}
    ...
    \begin{itemize}[topsep=0pt]
        ...
        \begin{itemize}
            \item zobrazovat a filtrovat statistiky z projektů, k nimž je uživatel přiřazen
    ...
    \begin{itemize}[topsep=0pt]
        ...
        \begin{itemize}
            ...
            \item zakládat a upravovat výzvy
