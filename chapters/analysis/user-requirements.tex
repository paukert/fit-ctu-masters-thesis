...
\begin{enumerate}[label=\textcolor{decoration}{\textbf{N\arabic*}}, leftmargin=9mm]
    \myItem{responzivita}
    Webová aplikace bude přizpůsobovat svůj vzhled na základě rozlišení klientského zařízení. Rozložení stránky bude minimálně optimalizováno pro chytré mobilní telefony (s displaji od šířky 360 px) a počítače (s displeji od šířky 1280 px).
